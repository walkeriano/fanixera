...
export default function AllAdsBrand({ nombreMarca }) {
  ...
  if (loading) {
    return <section className={styles.containerLoader}><LoaderSpecific /></section>;
  }
  ...
  return (
    <section className={styles.containerAllBrand}>
      <section className={styles.flextitleGeneral}>
        <h2 className={styles.titleContainer}>Beneficios libres publicados</h2>
      ...
      <section className={styles.sliderCardsBrand}>
        {promotions.map((promotion) => (
          <div key={promotion.id} className={styles.itemAdBrandTwo}>
            <section className={styles.imgAdCardTwo}>
